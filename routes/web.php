...
$router->post('search', App\Controllers\Client\HomeController::class.'@search');
...
$router->mount('/custommer',function() use($router){
    ...
    $router->get('/list',App\Controllers\Client\CustommerController::class.'@list');
    $router->get('/store',App\Controllers\Client\CustommerController::class.'@store');
    $router->post('/create',App\Controllers\Client\CustommerController::class.'@create');
    $router->get('/edit/{id}',App\Controllers\Client\CustommerController::class.'@edit');
    $router->post('/update/{id}',App\Controllers\Client\CustommerController::class.'@update');
    $router->get('/delete/{id}',App\Controllers\Client\CustommerController::class.'@delete');
...
$router->get('/{id}/order/complateee',App\Controllers\Client\OrderController::class.'@complate');
...
$router->mount('/admins',function() use($router){
    //taikhoantaikhoan
    $router->get('{id}/ban',App\Controllers\Auth\AuthController::class.'@ban');
    $router->get('{id}/active',App\Controllers\Auth\AuthController::class.'@active');
    ...
    $router->get('/listUserBan',App\Controllers\Admin\UserController::class.'@ban');
    //nhanvien
    $router->get('nhanvien/',App\Controllers\Admin\NhanVienController::class.'@index');
    $router->get('nhanvien/add',App\Controllers\Admin\NhanVienController::class.'@add');
    $router->post('nhanvien/store',App\Controllers\Admin\NhanVienController::class.'@store');
    $router->get('nhanvien/{id}/delete',App\Controllers\Admin\NhanVienController::class.'@delete');
    //đơn hàng
    ...
    $router->mount('/order',function() use($router){
        ...
        $router->get('ful',App\Controllers\Admin\OrderAdminController::class.'@ful');
