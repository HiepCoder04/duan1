        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <?php
$subtotal = 0; // Khởi tạo subtotal để tránh lỗi khi giỏ hàng trống
?>
...
<tbody class="align-middle">
    <?php if (empty($cart)) : ?>
        <tr>
            <td colspan="5" class="text-center">
                <p class="text-danger font-weight-bold">Không có sản phẩm nào trong giỏ hàng</p>
                <a href="<?= BASE_URL ?>shop" class="btn btn-warning">Mua ngay</a>
            </td>
        </tr>
    <?php else : ?>
        <?php
        ...
        ?>
            <tr>
                ...
                <td class="align-middle">
                    <a href="<?= BASE_URL . 'cart/remove/' . $key ?>" class="btn btn-sm btn-danger"
    ...
    <?php endif ?>
            ...
            <div class="col-lg-4">
    <form action="<?= BASE_URL ?>order" method="post" enctype="multipart/form-data" onsubmit="return validateCheckout();">
