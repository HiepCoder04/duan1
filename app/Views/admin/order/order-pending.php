              ...
              <div class="row mb-5">
                <div class="col-sm-4">
                    ...
                    <select class="form-control" id="orderStatusSelect">
                     ...
                     <table class="table">
                     <h3 class="mt-3 mb-5">Đơn hàng chờ xác nhận:</h3>
        <thead>
            <tr>
                <th>STT</th>
...
<?php foreach ($a as $key => $value) :
    ...
    ?>
            <tr>
                ...
                <a href="<?=BASE_URL?>admins/order/<?=$value['order_id']?>/confirm" class="btn btn-danger" onclick="return confirm('Bạn có  muốn xác nhận đơn hàng này không')">Xác nhận</a></td>
