            ...
            <tr>
                ...
                if ($value['order_status']==1) {
                   echo" Chờ xác nhận ";
                    ...
                    echo" Đã chuyển qua đơn vị vận chuyển ";
                ...
                <a href="<?=BASE_URL?>admins/order/<?=$value['order_id']?>/confirm/ship" class="btn btn-danger" onclick="return confirm('Bạn có  muốn chuyển đơn hàng này qua đơn vị vận chuyển không')">Chuyển sang đơn vị vận chuyển</a></td>
