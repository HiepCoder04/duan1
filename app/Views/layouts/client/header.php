                ...
                <div class="d-inline-flex align-items-center">
                    <?php if (isset($_SESSION['user_name'])):
                        ...
                        <div class="btn-group">
                            <button type="button" class="btn btn-sm btn-light dropdown-toggle"
                                data-toggle="dropdown"><?= $_SESSION['user_name'] ?></button>
                    ...
                    <?php else: ?>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="<?= BASE_URL ?>register" class="dropdown-item">Đăng kí</a>
                                <a href="<?= BASE_URL ?>login" class="dropdown-item">Đăng nhập</a>
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light"
                    ...
                    <div class="navbar-nav w-100">
                        <?php foreach ($listCate as $key => $value): ?>
                            <a href="<?= BASE_URL . $value->id ?>/probytype"
                                class="nav-item nav-link"><?= $value->category_name ?></a>
                        <?php endforeach ?>
                    </div>
                </nav>
            </div>
